    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* <div className="mb-4">
          <label htmlFor="inputField" className="block mb-2 text-lg font-bold ">
            Apellido materno:
          </label>
          <input
            id="inputField"
          ...
          <div>
            ...
            <input
              ...
              className="appearance-none bg-gray-800 border h-12 border-yellow-300 rounded-md py-2 px-4 leading-tight focus:outline-none  focus:border-gray-500"
            />
          </div>
          <div className="mb-4">
            <label
          ...
          >
            ...
            <option value={"farmacologia"}>Farmacologia(drogas)</option>
          </select>
        </div> */}
          <div>
