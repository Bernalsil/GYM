...
const ClientInfo = () => {
  ...
  return (
    <>
      <div>
        {/* <div>{client.estatura}</div>
        <button onClick={() => console.log(tracking)} className="btn">
          click
        </button> */}
      </div>
      {tracking && (
          ...
          <div className="pt-20 text-white">
            <div className="flex justify-between flex-wrap max-w-lg mx-auto">
              <div className="flex flex-col gap-3 ">
                ...
                <div>
                  Estatura:{" "}
                  <span className="font-bold">{client.estatura} </span>
                  mts
                </div>
                <div>
                  Enfermedades:{" "}
                ...
                <div>
                  Proteinas:{" "}
                  <span className="font-bold">{client.proteinas}</span>
                </div>
                <div>
                  carbohidratos:{" "}
                ...
                <div>
                  Hora Dormir:{" "}
                  <span className="font-bold">{client.hr_dormir}</span>
                </div>{" "}
                <div>
                  Objetivo a cumplir:{" "}
